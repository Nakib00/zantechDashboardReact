  ...
  const handleBundleItemChange = (index, field, value) => {
    ...
    if (field === "item_id" && value) {
      ...
      if (selectedProduct) {
        ...
        updatedBundleItems[index].unit_price =
    ...
    const quantity =
      field === "bundle_quantity"
        ? parseFloat(value) || 0
        : parseFloat(updatedBundleItems[index].bundle_quantity) || 0;
    ...
    try {
      ...
      if (isBundle && bundleItems.length > 0) {
        bundleItems.forEach((item, index) => {
          if (item.item_id) {
            formDataToSend.append(
              `bundls_item[${index}][item_id]`,
              item.item_id
            );
            formDataToSend.append(
              `bundls_item[${index}][bundle_quantity]`,
      ...
      <div className="product-option">
        ...
        <div className="product-option-details">
          ...
          <div className="product-option-meta">
            ...
            {product.quantity > 0 ? (
              <span className="product-option-stock in-stock">
                In Stock: {product.quantity}
              </span>
            ) : (
              <span className="product-option-stock out-of-stock">
                Out of Stock
              </span>
            )}
          </div>
                ...
                <div className="form-group">
                  ...
                  >
                    <div className="upload-area">
                      ...
                      <small>
                        Select multiple images (JPEG, PNG, GIF, max 4MB each)
                      </small>
                    </div>
                    <input
                      type="file"
            ...
            <div className="bundle-toggle">
              ...
              <label className="toggle-switch">
                ...
                <span className="toggle-label">
                  {isBundle ? "This is a bundle" : "Not a bundle"}
                </span>
              </label>
            </div>
          </Card.Header>
          ...
          {isBundle && (
            <Card.Body>
              <p className="info-text">
                Add products to include in this bundle
              </p>
